    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5 pt-1">
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-4 space-y-4 shadow-subtle">
          <div className="flex items-center gap-2 pb-2 border-b border-slate-100 text-xs font-bold uppercase tracking-wider text-slate-600">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                Incident Status <span className="text-rose-500">*</span>
              </label>
          ...
          {selectedIssueTypeMeta && (
            <div className="flex items-center gap-1.5 text-[11px] text-slate-500 bg-slate-50 px-2.5 py-1.5 rounded-lg border border-slate-100">
